...
function Admin() {
  const columns = [
    ...
    },
    {
      ...
      align: 'center',
      valueGetter: (params) => {
        const dateValue = params.value; // Get the original date value
        const formattedDate = moment(dateValue).format('DD-MM-YYYY'); // Format the date using moment.js
    ...
    <div className='admin-container'>
      ...
      <div style={{ display: 'flex', gap: '10px' }}>
        ...
        <div className='taskbox'>
          <Box sx={{ height: 400, marginLeft: '10px', marginTop: '16px', width: '1000px' }}>
            <div className='filter-container'>
             <label htmlFor='start-date'>From:</label>
              ...
              <button style={{marginTop:"10px"}} className='btn btn-dark' onClick={handleFilter}>
                Filter
              </button>
            </div>
