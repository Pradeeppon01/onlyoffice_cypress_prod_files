    ...
    <div style={{ display: 'flex', position: 'relative' }}>
      ...
      <div>
        ...
        <div style={{ position: 'absolute', top: '105px', left: '85px', fontSize: "40px", color: "white" }}>
          <i onClick={capturePhoto} className="ri-camera-fill"></i>
        </div>
        <div style={{ position: 'absolute', top: '2px', right: '370px', color: "white" }}>
          <i onClick={switchCamera} className="ri-camera-switch-line"></i>
        </div>
