...
const Addtask = () => {
  ...
  console.log(tasks.status)
    ...
    if (
    ...
    }else if(  tasks.status == co && tasks.quantity.length === 0 ){
      ...
      setTimeout(() => {
        setIsLoading(false);
        toast.success('Your Work Status Added Successfully');
      }, 4000);
    }
  };
...
const[showCamera,setShowCamera] = useState(false)
  ...
  style={{ display: 'flex', flexDirection: 'row' }} // Add grid styles
>
  <div>
