...
// }))
app.use(cors());
app.use('/thumbnails', express.static('/home/ponpradeeep/sakthipress.i4ulabs.com/frontend/src/uploads/thumbnails'));
app.use('/images', express.static('/home/ponpradeeep/sakthipress.i4ulabs.com/frontend/src/uploads/images'));
...
let directoryname = '/home/ponpradeeep/sakthipress.i4ulabs.com/frontend/src/uploads/images';
const thumbnailDirectory = '/home/ponpradeeep/sakthipress.i4ulabs.com/frontend/src/uploads/thumbnails';
...
`;
  ...
  db.query(createTasksTableQuery, (err) => {
    ...
    const insertTaskQuery = `
      INSERT INTO tasks (id, jobid, username, machinename, status, quantity,remarks, date, time, images, thumbnailimages)
      VALUES ('${id}', '${jobid}', '${employeeusername}', '${machinename}', '${status}', '${quantity}','${remarks}', '${date}', '${time}', '${imagesJson}', '${thumbnailImagesJson}')
    `;
